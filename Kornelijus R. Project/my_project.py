...
list_of_names = ['jonas', 'petras', 'antanas']

#personal_file = {name,age}
#print(personal_file)
# This will print clients name and age
#print("client {name} is {age} years old")
...
def print_persons_name():
    print(last_name)

for i in range(5):
    print_persons_name()

def quadratic_eqc(a,b,c,filename="results.txt"):
